...
(function() {
    ...
    // viewport : let the browser knows the current width and height of device.
    addMeta('viewport', 'width=device-width, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0, user-scalable=no');
    // apple-mobile-web-app-capable : Sets whether a web application runs in full-screen mode.(URL hidden)
    addMeta('apple-mobile-web-app-capable', 'yes');
    // apple-touch-fullscreen : full screen.
